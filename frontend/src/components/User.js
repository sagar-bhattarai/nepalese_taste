...
import { ADMIN_DASHBOARD_ROUTE, DASHBOARD_ROUTE, PROFILE_ROUTE } from "@/constants/routes";
    ...
    return (
        <div className="absolute right-0 top-11 p-4 z-10 bg-darkBackground border-gray-500 shadow rounded-md ">
            ...
            <div className={`flex flex-col`}>
                <Link onClick={() => setShow(false)} href={ roles.includes('ADMIN') ? ADMIN_DASHBOARD_ROUTE : DASHBOARD_ROUTE} className="py-1 px-2 hover:bg-primary light:text-white">Dashboard</Link>
