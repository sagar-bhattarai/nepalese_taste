      ...
      <div className="grid sm:grid-cols-2 gap-10">
        <div className="relative flex items-center">
          ...
          <input type="text" placeholder="Enter first name"
            className="px-4 py-3.5 pr-8 bg-transparent text-slate-900 font-medium w-full text-sm border-2 border-gray-400 dark:border-gray-500 focus:border-primary rounded-sm outline-none" />
        ...
        <div className="relative flex items-center">
          <label className="text-[13px] bg-lightBackground dark:bg-darkBackground dark:text-gray-400  5ont-medium absolute px-2 top-[-10px] left-[18px]">Last
            Name</label>
        ...
        <div className="relative flex items-center">
          <label className="text-[13px] bg-lightBackground dark:bg-darkBackground dark:text-gray-400  5ont-medium absolute px-2 top-[-10px] left-[18px]">Phone
            No</label>
        ...
        <div className="relative flex items-center">
          <label className="text-[13px] bg-lightBackground dark:bg-darkBackground dark:text-gray-400  font-medium absolute px-2 top-[-10px] left-[18px]">Country</label>
        ...
        <div className="relative flex items-center sm:col-span-2">
          <label className="text-[13px] bg-lightBackground dark:bg-darkBackground dark:text-gray-400  5ont-medium absolute px-2 top-[-10px] left-[18px]">Email</label>
        ...
        <div className="relative flex items-center sm:col-span-2">
          <label
            className="text-[13px] bg-lightBackground dark:bg-darkBackground dark:text-gray-400  rounded-sm font-medium absolute px-2 top-[-10px] left-[18px]">Password</label>
          <input type="password" autocomplete="new-password" placeholder="Enter password"
            className="px-4 py-3.5 pr-8 bg-transparent text-slate-900 font-medium w-full text-sm border-2 border-gray-400 dark:border-gray-500 focus:border-primary rounded outline-none" />
