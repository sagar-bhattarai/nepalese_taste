        ...
        <div className="grid lg:grid-cols-3 lg:gap-x-8 gap-x-6 gap-y-8 mt-6">
              ...
              <div key={product._id} className="flex gap-4 bg-[#ffffff38] dark:bg-[#2e2e2e4a] px-4 py-6 rounded-md shadow-sm border border-gray-200 dark:border-[#e5e7eb2e]">
                <div className="flex gap-6 sm:gap-4 max-sm:flex-col">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="mt-auto">
                      <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-500">$120.00</h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="ml-auto flex flex-col">
                  ...
                  <div className="flex items-center gap-3 mt-auto">
                    ...
                    <span className="font-semibold text-base leading-[18px] dark:text-slate-600">{product.quantity}</span>
                    <button type="button"
                      className="flex items-center justify-center w-[18px] h-[18px] cursor-pointer bg-slate-800 hover:bg-primary outline-none rounded-full">
          ...
          <div className="bg-[#ffffff38] dark:bg-[#2e2e2e4a] rounded-md px-4 py-6 h-max shadow-sm border border-gray-200 dark:border-[#e5e7eb2e]">
            <ul className="text-slate-500 font-medium space-y-4">
              <li className="flex flex-wrap gap-4 text-sm">Subtotal <span className="ml-auto font-semibold text-slate-900 dark:text-slate-500 ">$200.00</span></li>
              <li className="flex flex-wrap gap-4 text-sm">Shipping <span className="ml-auto font-semibold text-slate-900 dark:text-slate-500 ">$2.00</span></li>
              <li className="flex flex-wrap gap-4 text-sm">Tax <span className="ml-auto font-semibold text-slate-900 dark:text-slate-500 ">$4.00</span></li>
              <hr className="border-slate-300" />
              <li className="flex flex-wrap gap-4 text-sm font-semibold text-slate-900 dark:text-slate-500 ">Total <span className="ml-auto">$206.00</span></li>
            </ul>
