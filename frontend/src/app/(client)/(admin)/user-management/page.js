            ...
            <div className="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
              <div className="flex items-center flex-1 space-x-4">
                <h5>
                  ...
                  <span className="dark:text-white">{usersData?.total}</span>
                </h5>
                <h5>
                  <span className="text-gray-500">Total Active: </span>
                  <span className="dark:text-white">{usersData?.active}</span>
                </h5>
                <h5>
                  <span className="text-gray-500">Total Verified: </span>
                  <span className="dark:text-white">{usersData?.verified}</span>
                </h5>
              </div>
