...
const AboutUsPage = () => {
    return (
        <div>
            ...
            <section className="py-14 lg:py-24 relative z-0  dark:bg-[#a8b7b7e0] bg-[#0e041a]">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
                    <h1
                        className="max-w-2xl mx-auto text-center font-manrope font-bold text-4xl  text-primary mb-5 md:text-5xl md:leading-normal">
                        Control your Finances with our <span className="dark:text-slate-600 text-slate-400">Smart Tool </span>
                    </h1>
                    <p className="max-w-sm mx-auto text-center text-base font-normal leading-7 dark:text-slate-800 text-gray-200 mb-9">Invest
                        intelligently
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-9">
                        ...
                        <div className="lg:pl-[100px] flex items-center">
                            <div className="data w-full">
                                <h2
                                    className="font-manrope font-bold text-4xl lg:text-5xl dark:text-slate-600 text-black mb-9 max-lg:text-center relative">
                                    About
                                    Us </h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                        ...
                        <div className="lg:pr-24 flex items-center">
                            <div className="data w-full">
                                ...
                                <h2 className="font-manrope font-bold text-4xl lg:text-5xl dark:text-slate-600 text-black mb-9 max-lg:text-center">We
            ...
            <section className="py-20 dark:bg-gray-100/5 bg-gray-100/70">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col gap-5 xl:gap-8 lg:flex-row lg:justify-between">
                        <div
                            className="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 dark:bg-gray-100/5 bg-gray-100/80 p-6 rounded-2xl shadow-md shadow-gray-100">
            ...
            <section className=" py-14 lg:py-24 dark:bg-[#a8b7b7e0] bg-gray-100/40">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                <img src="https://pagedone.io/asset/uploads/1704349534.png" alt="Emily image"
                                    className="mx-auto scale-90 transition-all duration-300 swiper-slide:w-16 border rounded-full swiper-slide:border-primary object-cover" />
                            </div>
                            <div className="swiper-slide">
            ...
            <section className="py-14 lg:py-24 ">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                ...
                                <div
                                    ...
                                    <div className="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                        <div className="mb-5 pb-5 border-b border-solid border-gray-300">
                                            ...
                                            <span className="text-sm text-gray-500 group-hover:text-primary">Lead Designer</span>
                                        </div>
                                        <p className="text-gray-500 leading-6 mb-7">
                    ...
                    <button id="slider-button-left"
                        className="swiper-button-prev p-2.5 group flex justify-center items-center text-gray-900 w-12! h-12! transition-all duration-500 rounded-full hover:text-primary"
                        data-carousel-prev>
                    ...
                    <button id="slider-button-right"
                        className="swiper-button-next p-2.5 group flex justify-center items-center text-gray-900 w-12! h-12! transition-all duration-500 rounded-full hover:text-primary"
                        data-carousel-next>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path
            ...
            <section className="py-20 ">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="bg-primary rounded-2xl p-8 xl:p-11">
                        <h2 className="font-manrope text-4xl dark:text-slate-400 text-white text-center font-bold mb-4">Subscribe to the latest offer
                        </h2>
                        <p className="text-slate-800 text-center mb-11 max-lg:max-w-2xl mx-auto">Join our community of subscribers
                            and receive regular
                            updates delivered straight to your inbox. It's quick, easy, and free</p>
                        <div
                            className="max-w-md mx-auto lg:bg-transparent lg:border border-slate-800 rounded-3xl max-lg:py-3 lg:rounded-full lg:h-12 lg:p-1.5 lg:flex-row gap-6 lg:gap-0 flex-col flex items-center justify-between">
                            <input type="text" name="email"
                                className="py-2 px-6 bg-transparent rounded-full max-lg:border border-slate-800  text-gray-100 max-lg:text-center placeholder:text-gray-400 focus:outline-hidden flex-1 w-full lg:w-auto lg:py-2 lg:px-6 lg:bg-transparent"
                                placeholder="Enter your email.." />
                            <button type="submit"
                                className="py-2 px-5 text-sm bg-[#a8b7b7e0] shadow-md rounded-full  text-white hover:text-primary font-semibold hover:bg-white">Subscribe</button>
                        </div>
                    </div>
                </div>
            </section>
